...
const events = [
  // ══════════════════ TECHNICAL (18) ══════════════════
  {
    ...
    registrationFee: 0, prize: { description: "Certificates + Goodies" },
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Certificates + Recognition" },
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Cash prizes + Certificates" },
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Trophies + Certificates + Goodies" },
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Trophies + Cash prizes + Certificates" },
  ...
  },
  {
    ...
    eligibility: "UG/PG students", teamSize: { min: 1, max: 5, label: "Team of up to 5 members" },
    registrationFee: 0, prize: { description: "Trophies + Certificates" },
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Championship trophy + Cash prizes" },
    facultyCoordinators: [], studentCoordinators: []
  },
  {
  ...
  },
  {
    ...
    rules: ["Round 1: AI-based quiz (MCQs on programming fundamentals + AI concepts)", "Round 2: Debugging challenge (fix errors in provided code snippets)", "Round 3: Final coding round (solve problem / complete program under time limit)", "Evaluation: accuracy, syntax correctness, logic, and time taken", "No registration fee for this event"],
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Cash prizes + Mentorship + Certificates" },
  ...
  },
  {
    ...
    eligibility: "UG/PG students", teamSize: { min: 2, max: 2, label: "Team of 2 members" },
    registrationFee: 0, prize: { description: "Certificates + Publication opportunity" },
  ...
  },
  {
    ...
    registrationFee: 0, prize: { description: "Diamond prize pool + Certificates" },
