...
const seed = async () => {
  try {
    ...
    for (const eventData of events) {
      ...
      insertedCount++;
      if (updated.feeType === 'per_person') perPersonCount++;
      if (updated.feeType === 'per_team') perTeamCount++;
    }

    console.log(`\n✅ Seeded ${insertedCount} events successfully`);
    console.log(`🧍 Events with per_person fee: ${perPersonCount}`);
    console.log(`👥 Events with per_team fee: ${perTeamCount}`);
